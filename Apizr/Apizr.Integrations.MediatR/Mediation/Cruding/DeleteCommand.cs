...
namespace Apizr.Mediation.Cruding
{
    ...
    public class DeleteCommand<T, TKey> : DeleteCommandBase<T, TKey, Unit, IApizrRequestOptions, IApizrRequestOptionsBuilder>
    {
        /// <summary>
    ...
    /// </summary>
    /// <typeparam name="T">The api entity type</typeparam>
    public class DeleteCommand<T> : DeleteCommandBase<T, IApizrRequestOptions, IApizrRequestOptionsBuilder>
    {
        /// <summary>
        /// The mediation Delete command constructor
        /// </summary>
