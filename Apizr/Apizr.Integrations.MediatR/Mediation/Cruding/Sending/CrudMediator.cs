...
namespace Apizr.Mediation.Cruding.Sending
{
    public class CrudMediator<TApiEntity, TApiEntityKey, TReadAllResult, TReadAllParams> : ICrudMediator<TApiEntity, TApiEntityKey, TReadAllResult, TReadAllParams> where TApiEntity : class
    {
        ...
        {
            return _mediator.Send(new CreateCommand<TApiEntity>(payload, context));
        }
        ...
        public Task<TApiEntity> SendCreateCommand(TApiEntity payload, Context context, CancellationToken cancellationToken)
        {
            return _mediator.Send(new CreateCommand<TApiEntity>(payload, context), cancellationToken);
        }
        ...
        {
            return _mediator.Send(new CreateCommand<TModelEntity>(payload, context));
        }
        ...
        public Task<TModelEntity> SendCreateCommand<TModelEntity>(TModelEntity payload, Context context, CancellationToken cancellationToken)
        {
            return _mediator.Send(new CreateCommand<TModelEntity>(payload, context), cancellationToken);
        }
        ...
        {
            return _mediator.Send(new ReadAllQuery<TReadAllResult>(context));
        }
        ...
        {
            return _mediator.Send(new ReadAllQuery<TReadAllResult>(priority, context));
        }
        ...
        {
            return _mediator.Send(new ReadAllQuery<TReadAllResult>(context), cancellationToken);
        }

        public Task<TReadAllResult> SendReadAllQuery(int priority, Context context, CancellationToken cancellationToken)
        {
            return _mediator.Send(new ReadAllQuery<TReadAllResult>(priority, context), cancellationToken);
        }
        ...
        {
            return _mediator.Send(new ReadAllQuery<TModelEntityReadAllResult>(context));
        }
        ...
        public Task<TModelEntityReadAllResult> SendReadAllQuery<TModelEntityReadAllResult>(int priority, Context context)
        {
            return _mediator.Send(new ReadAllQuery<TModelEntityReadAllResult>(priority, context));
        }

        public Task<TModelEntityReadAllResult> SendReadAllQuery<TModelEntityReadAllResult>(Context context, CancellationToken cancellationToken)
        {
            return _mediator.Send(new ReadAllQuery<TModelEntityReadAllResult>(context), cancellationToken);
        }

        public Task<TModelEntityReadAllResult> SendReadAllQuery<TModelEntityReadAllResult>(int priority, Context context, CancellationToken cancellationToken)
        {
            return _mediator.Send(new ReadAllQuery<TModelEntityReadAllResult>(priority, context), cancellationToken);
        }
        ...
        {
            return _mediator.Send(new ReadAllQuery<TReadAllParams, TReadAllResult>(readAllParams, context));
        }
        ...
        {
            return _mediator.Send(new ReadAllQuery<TReadAllParams, TReadAllResult>(readAllParams, priority, context));
        }
        ...
        public Task<TReadAllResult> SendReadAllQuery(TReadAllParams readAllParams, Context context, CancellationToken cancellationToken)
        {
            return _mediator.Send(new ReadAllQuery<TReadAllParams, TReadAllResult>(readAllParams, context), cancellationToken);
        }

        public Task<TReadAllResult> SendReadAllQuery(TReadAllParams readAllParams, int priority, Context context, CancellationToken cancellationToken)
        {
            return _mediator.Send(new ReadAllQuery<TReadAllParams, TReadAllResult>(readAllParams, priority, context), cancellationToken);
        }
        ...
        public Task<TModelEntityReadAllResult> SendReadAllQuery<TModelEntityReadAllResult>(TReadAllParams readAllParams, Context context)
        {
            return _mediator.Send(new ReadAllQuery<TReadAllParams, TModelEntityReadAllResult>(readAllParams, context));
        }
        ...
        public Task<TModelEntityReadAllResult> SendReadAllQuery<TModelEntityReadAllResult>(TReadAllParams readAllParams, int priority, Context context)
        {
            return _mediator.Send(new ReadAllQuery<TReadAllParams, TModelEntityReadAllResult>(readAllParams, priority, context));
        }
        ...
        public Task<TModelEntityReadAllResult> SendReadAllQuery<TModelEntityReadAllResult>(TReadAllParams readAllParams, Context context,
            CancellationToken cancellationToken)
        {
            return _mediator.Send(new ReadAllQuery<TReadAllParams, TModelEntityReadAllResult>(readAllParams, context), cancellationToken);
        }

        public Task<TModelEntityReadAllResult> SendReadAllQuery<TModelEntityReadAllResult>(TReadAllParams readAllParams, int priority, Context context,
            CancellationToken cancellationToken)
        {
            return _mediator.Send(new ReadAllQuery<TReadAllParams, TModelEntityReadAllResult>(readAllParams, priority, context), cancellationToken);
        }
        ...
        {
            return _mediator.Send(new ReadQuery<TApiEntity, TApiEntityKey>(key, context));
        }
        ...
        {
            return _mediator.Send(new ReadQuery<TApiEntity, TApiEntityKey>(key, context), cancellationToken);
        }

        public Task<TApiEntity> SendReadQuery(TApiEntityKey key, int priority, Context context)
        {
            return _mediator.Send(new ReadQuery<TApiEntity, TApiEntityKey>(key, priority, context));
        }
        ...
        public Task<TApiEntity> SendReadQuery(TApiEntityKey key, int priority, Context context, CancellationToken cancellationToken)
        {
            return _mediator.Send(new ReadQuery<TApiEntity, TApiEntityKey>(key, priority, context), cancellationToken);
        }
        ...
        {
            return _mediator.Send(new ReadQuery<TModelEntity, TApiEntityKey>(key, context));
        }
        ...
        public Task<TModelEntity> SendReadQuery<TModelEntity>(TApiEntityKey key, Context context, CancellationToken cancellationToken)
        {
            return _mediator.Send(new ReadQuery<TModelEntity, TApiEntityKey>(key, context), cancellationToken);
        }

        public Task<TModelEntity> SendReadQuery<TModelEntity>(TApiEntityKey key, int priority, Context context)
        {
            return _mediator.Send(new ReadQuery<TModelEntity, TApiEntityKey>(key, priority, context));
        }
        ...
        public Task<TModelEntity> SendReadQuery<TModelEntity>(TApiEntityKey key, int priority, Context context, CancellationToken cancellationToken)
        {
            return _mediator.Send(new ReadQuery<TModelEntity, TApiEntityKey>(key, priority, context), cancellationToken);
        }
        ...
        {
            return _mediator.Send(new UpdateCommand<TApiEntityKey, TApiEntity>(key, payload, context));
        }
        ...
        public Task SendUpdateCommand(TApiEntityKey key, TApiEntity payload, Context context, CancellationToken cancellationToken)
        {
            return _mediator.Send(new UpdateCommand<TApiEntityKey, TApiEntity>(key, payload, context), cancellationToken);
        }
        ...
        {
            return _mediator.Send(new UpdateCommand<TApiEntityKey, TModelEntity>(key, payload, context));
        }
        ...
        public Task SendUpdateCommand<TModelEntity>(TApiEntityKey key, TModelEntity payload, Context context,
            CancellationToken cancellationToken)
        {
            return _mediator.Send(new UpdateCommand<TApiEntityKey, TModelEntity>(key, payload, context), cancellationToken);
        }
        ...
        {
            return _mediator.Send(new DeleteCommand<TApiEntity, TApiEntityKey>(key, context));
        }
