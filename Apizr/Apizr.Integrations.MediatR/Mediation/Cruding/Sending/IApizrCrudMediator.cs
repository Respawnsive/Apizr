...
namespace Apizr.Mediation.Cruding.Sending
{
    ...
    public interface IApizrCrudMediator : IApizrCrudMediatorBase
    {
        ...
        /// <param name="optionsBuilder">Options provided to the request</param>
        /// <returns></returns>
        Task<TReadAllResult> SendReadAllQuery<TReadAllResult>(int priority, Action<IApizrRequestOptionsBuilder> optionsBuilder = null);
        ...
        /// <param name="optionsBuilder">Options provided to the request</param>
        /// <returns></returns>
        Task<TModelReadAllResult> SendReadAllQuery<TModelReadAllResult, TApiReadAllResult>(int priority, Action<IApizrRequestOptionsBuilder> optionsBuilder = null);
        ...
        where TApiEntity : class
    {
        ...
        /// <param name="optionsBuilder">Options provided to the request</param>
        /// <returns></returns>
        Task<TReadAllResult> SendReadAllQuery(int priority, Action<IApizrRequestOptionsBuilder> optionsBuilder = null);
        ...
        /// <param name="optionsBuilder">Options provided to the request</param>
        /// <returns></returns>
        Task<TModelEntityReadAllResult> SendReadAllQuery<TModelEntityReadAllResult>(int priority, Action<IApizrRequestOptionsBuilder> optionsBuilder = null);
