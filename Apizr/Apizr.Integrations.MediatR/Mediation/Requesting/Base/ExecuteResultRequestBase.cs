...
namespace Apizr.Mediation.Requesting.Base
{
    ...
    {
        protected ExecuteResultRequestBase(Expression<Func<TWebApi, Task<TApiResultData>>> executeApiMethod) : base(
            executeApiMethod)
        {
        }

        protected ExecuteResultRequestBase(
            Expression<Func<CancellationToken, TWebApi, Task<TApiResultData>>> executeApiMethod) : base(
            executeApiMethod)
        {
        }

        protected ExecuteResultRequestBase(Expression<Func<Context, TWebApi, Task<TApiResultData>>> executeApiMethod,
            Context context) : base(executeApiMethod, context)
        {
        }
    ...
    {
        protected ExecuteResultRequestBase(Expression<Func<TWebApi, Task<TApiData>>> executeApiMethod) : base(
            executeApiMethod)
        {
        }

        protected ExecuteResultRequestBase(
            Expression<Func<CancellationToken, TWebApi, Task<TApiData>>> executeApiMethod) : base(executeApiMethod)
        {
        }
        ...
        protected ExecuteResultRequestBase(
            Expression<Func<Context, CancellationToken, TWebApi, Task<TApiData>>> executeApiMethod, Context context) :
            base(executeApiMethod, context)
        {
        }
        ...
        protected ExecuteResultRequestBase(
            ...
            Context context) : base(executeApiMethod, modelData, context)
        {
        }
