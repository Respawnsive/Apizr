...
namespace Apizr.Optional.Requesting.Sending
{
    ...
    public interface IApizrOptionalMediator : IApizrOptionalMediatorBase
    {
        ...
        /// <param name="executeApiMethod">The <see cref="TWebApi"/> call to execute</param>
        /// <returns></returns>
        Task<Option<TApiData, ApizrException<TApiData>>> SendFor<TWebApi, TApiData>(Expression<Func<TWebApi, Task<TApiData>>> executeApiMethod);
    ...
    /// <summary>
    /// <see cref="IApizrOptionalMediator"/> but dedicated to <see cref="TWebApi"/> with optional result, getting all shorter
    /// </summary>
    public interface IApizrOptionalMediator<TWebApi> : IApizrOptionalMediatorBase
    {
        ...
        /// <param name="executeApiMethod">The <see cref="TWebApi"/> call to execute</param>
        /// <returns></returns>
        Task<Option<TApiData, ApizrException<TApiData>>> SendFor<TApiData>(Expression<Func<TWebApi, Task<TApiData>>> executeApiMethod);
