...
namespace Apizr
{
    public static class ApizrManagerExtensions
    {
        ...
        public static Task<TApiData> ExecuteAsync<TWebApi, TApiData>(this IApizrManager<TWebApi> manager,
            ...
            => manager.ExecuteAsync<TApiData>(api => executeApiMethod.Compile()(api),
                options => options.WithCacheCleared(clearCache).WithExceptionCatcher(onException));
        ...
        public static Task<TApiData> ExecuteAsync<TWebApi, TApiData>(this IApizrManager<TWebApi> manager,
            ...
            => manager.ExecuteAsync<TApiData>(
                ...
                options => options.WithCancellationToken(cancellationToken).WithCacheCleared(clearCache)
                    .WithExceptionCatcher(onException));
        ...
        public static Task<TApiData> ExecuteAsync<TWebApi, TApiData>(this IApizrManager<TWebApi> manager,
            ...
            => manager.ExecuteAsync<TApiData>(
                ...
                options => options.WithContext(context).WithCancellationToken(cancellationToken)
