...
> **Deprecated**
> 
> As Apizr.Tools.NSwag is now deprecated and will be removed in a future version, please consider using [Refitter](tools_refitter.md) instead which now can generate all the Apizr boilerplate and more.
