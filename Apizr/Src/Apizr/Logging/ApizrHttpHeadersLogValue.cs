// This code was taken from https://github.com/dotnet/runtime/blob/main/src/libraries/Microsoft.Extensions.Http/src/Logging/HttpHeadersLogValue.cs
...
{
    internal sealed class ApizrHttpHeadersLogValue : IReadOnlyList<KeyValuePair<string, object>>
    {
        ...
        public ApizrHttpHeadersLogValue(Kind kind, HttpHeaders headers, HttpHeaders? contentHeaders, Func<string, bool> shouldRedactHeaderValue)
        {
            _kind = kind;
