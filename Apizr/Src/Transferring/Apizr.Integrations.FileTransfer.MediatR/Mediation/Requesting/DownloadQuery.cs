...
namespace Apizr.Mediation.Requesting
{
    ...
    public class DownloadQuery<TDownloadApi, TDownloadParams> : MediationQueryBase<FileInfo, IApizrRequestOptions, IApizrRequestOptionsBuilder>
        where TDownloadApi : IDownloadApi<TDownloadParams>
    {
        ...
        public DownloadQuery(FileInfo fileInfo, TDownloadParams downloadParams, Action<IApizrRequestOptionsBuilder> optionsBuilder = null) : base(optionsBuilder)
        {
            FileInfo = fileInfo;
    ...
    /// </summary>
    public class DownloadQuery<TDownloadApi> : DownloadQuery<TDownloadApi, IDictionary<string, object>>
        where TDownloadApi : IDownloadApi
    {
        ...
        /// <param name="fileInfo">Some information about the file to download</param>
        /// <param name="optionsBuilder">Some request options</param>
        public DownloadQuery(FileInfo fileInfo, Action<IApizrRequestOptionsBuilder> optionsBuilder = null) : base(fileInfo, null, optionsBuilder)
        {
        }
        ...
        /// <param name="optionsBuilder">Some request options</param>
        public DownloadQuery(FileInfo fileInfo, IDictionary<string, object> downloadParams, Action<IApizrRequestOptionsBuilder> optionsBuilder = null) : base(fileInfo, downloadParams, optionsBuilder)
        {
        }
    }
    ...
    /// The mediation download query with a dictionary query parameters type
    /// </summary>
    public class DownloadQuery : DownloadQuery<IDownloadApi>
    {
        /// <summary>
        /// The mediation Read query constructor
        /// </summary>
