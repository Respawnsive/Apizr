...
- [New] [Generator] **Apizr files could now be generated by command line** (Models, Services and Registration) from an OpenApi definition using NSwag
- [New] [Core] Now we can **group registry common configurations** at any level to share configurations without limit
